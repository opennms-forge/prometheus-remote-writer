...
- Karaf feature `prometheus-remote-writer` shipping a pre-populated
  `etc/org.opennms.plugins.tss.prometheus-remote-writer.cfg` on install.
...
[Unreleased]: https://github.com/OpenNMS/prometheus-remote-writer/compare/v0.1.0...HEAD
[0.1.0]: https://github.com/OpenNMS/prometheus-remote-writer/releases/tag/v0.1.0
